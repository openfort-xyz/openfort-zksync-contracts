...
task("deploy-factory", "Deploy an Openfort Factory")
    ...
    .setAction(async (args, hre) => {
        ...
        // Use the correct method to get the proxy bytecode hash
        const proxyBytecodeHash = utils.getBytecodeHash(proxyArtifact.bytecode);

        // DEBUG: Logging the computed hash for comparison
        console.log("Computed proxy bytecode hash: ", proxyBytecodeHash);
